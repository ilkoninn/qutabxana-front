      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-primary text-sm">{t("home.hero_subtitle")}</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-700 text-sm">
              <div>
                <p className="font-semibold text-gray-800 mb-1">📍 {t("footer.location_label")}</p>
                <p>{t("contact.address")}</p>
              </div>
              <div>
                <p className="font-semibold text-gray-800 mb-1">📞 {t("footer.phone_label")}</p>
                <a
                  href="tel:+994514560077"
                  className="hover:text-primary transition-colors"
                >
                  051 456 00 77
                </a>
        ...
        <div className="border-t border-gray-300 mt-8 pt-6 text-center text-gray-700 text-sm">
          {t("footer.copyright")}
        </div>
      </div>
    </footer>
